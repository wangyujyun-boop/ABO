...
def load_and_process_data():
    ...
    # 完全改用位置索引（Index）鎖定前兩欄，徹底防範中英文字串不對齊產生的 KeyError
    ...
    country_translation = {
        ...
        "Luxembourg": "盧森堡", "Malaysia": "馬來西亞", "Mauritius": "模里西斯", "Mexico": "墨西哥",
    ...
    df_melted = pd.melt(
        df,
        id_vars=['國家中文名稱', col_en_name, col_pop_num],
    ...
    # 記憶體內將欄位正名，方便後續程式碼一致呼叫
    df_melted = df_melted.rename(columns={
        col_en_name: '國家英文名稱',
        col_pop_num: '總人口'
    })
    
    # 【新增特徵】根據血型組合結尾字元，歸類 Rh 因子
